...
{
    public partial class AddPosSales : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(name: "IX_Payments_SaleId", table: "Payments", column: "SaleId");
            migrationBuilder.CreateIndex(name: "IX_SaleItemExtras_ExtraId", table: "SaleItemExtras", column: "ExtraId");
            migrationBuilder.CreateIndex(name: "IX_SaleItemExtras_SaleItemId", table: "SaleItemExtras", column: "SaleItemId");
            migrationBuilder.CreateIndex(name: "IX_SaleItems_ProductId", table: "SaleItems", column: "ProductId");
            migrationBuilder.CreateIndex(name: "IX_SaleItems_SaleId", table: "SaleItems", column: "SaleId");
            migrationBuilder.CreateIndex(name: "IX_SaleItemSelections_OptionItemId", table: "SaleItemSelections", column: "OptionItemId");
            migrationBuilder.CreateIndex(name: "IX_SaleItemSelections_SaleItemId", table: "SaleItemSelections", column: "SaleItemId");
            migrationBuilder.CreateIndex(name: "IX_Sales_ClientSaleId", table: "Sales", column: "ClientSaleId", unique: true, filter: "[ClientSaleId] IS NOT NULL");
            migrationBuilder.CreateIndex(name: "IX_Sales_OccurredAtUtc", table: "Sales", column: "OccurredAtUtc");
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "Payments");
            migrationBuilder.DropTable(name: "SaleItemExtras");
            migrationBuilder.DropTable(name: "SaleItemSelections");
