                    ...
                    <td>
                      <div class="action-buttons">
                        ...
                        <button
                          type="button"
                          class="btn-outline btn-small"
                          [attr.data-testid]="'tenant-view-details-' + item.id"
                        ...
                        @if (selectedTenantId() === item.id) {
                          <span
                            class="context-badge"
                            [attr.data-testid]="'tenant-context-active-' + item.id"
                          >
                            Activo
                          </span>
                        }
...
export class TenantsPage {
  ...
  readonly verticalControl = new FormControl('', {
    nonNullable: true,
    validators: [Validators.required],
  });
  readonly isActiveControl = new FormControl(
  ...
  viewDetails(tenantId: string) {
    void this.router.navigate(['/app/platform/tenants', tenantId]);
  }
